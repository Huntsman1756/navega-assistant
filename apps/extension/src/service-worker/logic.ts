 ...
 * longer than the backend's complete assist budget (12000 ms), which includes
 * one provider hedge. The 4000 ms margin covers response
 * serialization and message passing. The extension does not retry itself.
 */
export const BACKEND_REQUEST_TIMEOUT_MS = 16000;
